...
namespace :foreman do
  ...
  task :export do
    ...
    export_cmd = "#{sudo_cmd} #{bundle_bin} exec foreman export #{foreman_format} #{foreman_location} -a #{foreman_app} -u #{foreman_user} -d #{deploy_to!}/#{current_path!} -l #{foreman_log}"
